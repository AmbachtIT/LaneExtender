...
namespace Ambacht.Common.CitiesSkylines.Rendering
{
    public static class RenderExtensions
    {
        ...
        public static void RenderCircle(this Vector3 position, OverlayData data, float? width = null)
        {
            var color = data.Color ?? DefaultColor;
            ...
            DrawCircle(data.CameraInfo, color, position, width.Value, minLimit, maxLimit, renderLimit, alphaBlend);
        }
        ...
        public static void DrawBezier(RenderManager.CameraInfo cameraInfo, Color color, Bezier3 bezier, float size, float cutStart, float cutEnd, float minY, float maxY, bool renderLimits, bool alphaBlend)
        {
        ...
        public static void DrawQuad(RenderManager.CameraInfo cameraInfo, Color color, Quad3 quad, float minY, float maxY, bool renderLimits, bool alphaBlend)
        {
            var min = quad.Min();
            var max = quad.Max();
        ...
        public static void DrawCircle(RenderManager.CameraInfo cameraInfo, Color color, Vector3 center, float size, float minY, float maxY, bool renderLimits, bool alphaBlend)
        {
